...
export const productApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getAllProducts: builder.query<ProductWithNumber, { page: number; limit: number }>({
            query: ({ page, limit }) => ({
        ...
        getProductReviews: builder.query<[Review[], number], { page: number; limit: number; productId: string }>({
        ...
        getProductsSortedByPrice: builder.query<[Product[], number], { order: 'ASC' | 'DESC'; page: number; limit: number }>({
        ...
        getProductsSortedByRating: builder.query<[Product[], number], { order: 'ASC' | 'DESC'; page: number; limit: number }>({
            query: ({ order, page, limit }) => ({
        ...
        getProductsSortedBySoldUnits: builder.query<[Product[], number], { order: 'ASC' | 'DESC'; page: number; limit: number }>({
            query: ({ order, page, limit }) => ({
        ...
        getProductsSortedByPriceForCategory: builder.query<[Product[], number], { categoryId: string; order: 'ASC' | 'DESC'; page: number; limit: number }>({
        ...
        getProductsSortedByRatingForCategory: builder.query<[Product[], number], { categoryId: string; order: 'ASC' | 'DESC'; page: number; limit: number }>({
            query: ({ categoryId, order, page, limit }) => ({
        ...
        getProductsSortedBySoldUnitsForCategory: builder.query<[Product[], number], { categoryId: string; order: 'ASC' | 'DESC'; page: number; limit: number }>({
            query: ({ categoryId, order, page, limit }) => ({
        ...
        getProductsSortedByPriceForGroup: builder.query<[Product[], number], { groupId: string; order: 'ASC' | 'DESC'; page: number; limit: number }>({
        ...
        getProductsSortedByRatingForGroup: builder.query<[Product[], number], { groupId: string; order: 'ASC' | 'DESC'; page: number; limit: number }>({
            query: ({ groupId, order, page, limit }) => ({
        ...
        getProductsSortedBySoldUnitsForGroup: builder.query<[Product[], number], { groupId: string; order: 'ASC' | 'DESC'; page: number; limit: number }>({
            query: ({ groupId, order, page, limit }) => ({
